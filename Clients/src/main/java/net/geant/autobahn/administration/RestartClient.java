...
public class RestartClient {
	...
	private static final QName SERVICE_NAME = new QName(
			"http://administration.autobahn.geant.net/",
			"AdministrationService");
	private final static QName AdministrationPort = new QName(
			"http://administration.autobahn.geant.net/", "AdministrationPort");

	private Administration adm = null;

	public RestartClient(String target) {
		Service service = Service.create(SERVICE_NAME);
		service.addPort(AdministrationPort, SOAPBinding.SOAP11HTTP_BINDING,
				target);
	...
	public static void main(String args[]) throws Exception {
		...
		RestartClient instance = new RestartClient("http://" + idm + ":" + port
		...
		instance.adm.handleTopologyChange(removeRsv, true);
